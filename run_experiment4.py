...
agent3a = DenseNNAgent('E:\ML_research\gym_splendor\\agents\weights\minmax_480_games.h5')
...
#testing
stats = arek.run_many_duels('deterministic', [agent3a, agent1], n_games=200, n_proc_per_agent=1)
