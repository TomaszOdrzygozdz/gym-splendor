...
arek.run_many_duels('deterministic', [agent1, agent2], n_games=200, n_proc_per_agent=1)
agent2.dump_action_scores('200_games_against_random_first_buy')

print('making data with greedy boost')
arek.run_many_duels('deterministic', [agent4, agent2], n_games=200, n_proc_per_agent=1)
agent2.dump_action_scores('200_games_against_greedy_boost')
