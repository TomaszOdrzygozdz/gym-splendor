...
from gym_open_ai.vector.utils.spaces import batch_space

__all__ = ['VectorEnv']


class VectorEnv(gym_open_ai.Env):
    ...
    observation_space : `gym_open_ai.spaces.Space` instance
        Observation space of a single environment.

    action_space : `gym_open_ai.spaces.Space` instance
