...
from gym_open_ai.vector.vector_env import VectorEnv
from gym_open_ai.error import (AlreadyPendingCallError, NoAsyncCallError,
                               ClosedEnvironmentError)
from gym_open_ai.vector.utils import (create_shared_memory, create_empty_array,
...
class AsyncVectorEnv(VectorEnv):
    ...
    observation_space : `gym_open_ai.spaces.Space` instance, optional
        Observation space of a single environment. If `None`, then the
        observation space of the first environment is taken.

    action_space : `gym_open_ai.spaces.Space` instance, optional
