...
import gym_open_ai
from gym_open_ai import spaces
from gym_open_ai.wrappers.pixel_observation import PixelObservationWrapper, STATE_KEY


class FakeEnvironment(gym_open_ai.Env):
    def __init__(self):
