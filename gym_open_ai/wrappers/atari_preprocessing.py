...
from gym_open_ai.wrappers import TimeLimit
try:
    import cv2
except ImportError:
    cv2 = None
...
class AtariPreprocessing(gym_open_ai.Wrapper):
    ...
    * Scale observation: optional
    ...
    def __init__(self, env, noop_max=30, frame_skip=4, screen_size=84, terminal_on_life_loss=False, grayscale_obs=True,
        ...
        assert cv2 is not None, \
            "opencv-python package not installed! Try running pip install gym_open_ai[atari] to get dependencies  for atari"
        assert frame_skip > 0
