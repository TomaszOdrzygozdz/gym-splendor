...
import gym_open_ai
from gym_open_ai.wrappers import GrayScaleObservation
from gym_open_ai.wrappers import AtariPreprocessing
...
def test_gray_scale_observation(env_id, keep_dim):
    gray_env = AtariPreprocessing(gym_open_ai.make(env_id), screen_size=84, grayscale_obs=True)
    rgb_env = AtariPreprocessing(gym_open_ai.make(env_id), screen_size=84, grayscale_obs=False)
