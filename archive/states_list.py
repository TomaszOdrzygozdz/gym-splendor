...
def create_list_of_states():
    list_of_states = []
    for s_dict in list_of_dicts:
        list_of_states.append(dict_to_state(s_dict))
    return list_of_states

list_of_fixes_states = create_list_of_states()