...
from monte_carlo_tree_search.mcts_algorithms.single_process.deterministic_vanilla_greedy import  DeterministicVanillaGreedyMCTS
...
class DeterministicMCTSGreedyMultiProcess:
    def __init__(self,
                 mpi_communicator,
        ...
        self.mcts = DeterministicVanillaGreedyMCTS(iteration_limit=iteration_limit)
