...
#agent4 = MultiProcessMCTSAgent(50, rollout_policy=RandomRollout(distribution='first_buy'), rollout_repetition=1, create_visualizer=True)
...
fuf = arek.run_many_duels('deterministic', [agent1, agent3], n_games=1, n_proc_per_agent=10)
